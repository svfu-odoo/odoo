...
class AccountJournal(models.Model):
    ...
    restrict_mode_hash_table = fields.Boolean(string="Lock Posted Invoices with Hash",
        help="If ticked, when the invoice is posted, the hash chain will be computed from the last move hashed to the new move to be hashed. The hash can also be performed on demand by the Lock Entries wizard.")
