...
class AccountEdiFormat(models.Model):
    ...
    def _l10n_eg_eta_prepare_invoice_lines_data(self, invoice, tax_data):
        ...
        for line in invoice.invoice_line_ids.filtered(lambda x: x.display_type not in ('line_note', 'line_section')):
            ...
            price_unit = self._l10n_eg_edi_round(abs(line.gross_price_unit) / invoice.currency_rate)
            price_subtotal_before_discount = self._l10n_eg_edi_round(abs(line.gross_price_unit * line.quantity) / invoice.currency_rate)
