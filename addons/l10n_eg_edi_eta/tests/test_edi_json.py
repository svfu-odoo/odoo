...
class TestEdiJson(TestEGEdiCommon):
                    ...
                    'request': {**COMMON_REQUEST_DICT,
                        ...
                        'invoiceLines': [
                            ...
                            },
                            {
                                ...
                                'totalTaxableFees': 0.0,
                                'itemsDiscount': 0.0,
                                'unitValue': {'currencySold': 'EGP', 'amountEGP': 99.96},
                        ...
                        'totalDiscountAmount': 11.2,
                        'totalSalesAmount': 111.96,
                        'netAmount': 100.76,
                        'totalAmount': 114.86,
                    },
                    'response': ETA_TEST_RESPONSE,
            ...
            self.assertEqual(
                json_file,
                {
                    'request': {**COMMON_REQUEST_DICT,
                        ...
                        'invoiceLines': [
                            {
                                ...
                                'itemsDiscount': 0.0,
                                'unitValue': {'currencySold': 'EGP', 'amountEGP': 120.99},
                                'discount': {'rate': 10.0, 'amount': 12.1},
                            ...
                            },
                            {
                                ...
                                'totalTaxableFees': 0.0,
                                'itemsDiscount': 0.0,
                                'unitValue': {'currencySold': 'EGP', 'amountEGP': 999.55},
                                'discount': {'rate': 10.0, 'amount': 99.95},
                        ...
                        'totalDiscountAmount': 112.05,
                        'totalSalesAmount': 1120.54,
                        'netAmount': 1008.49,
                        'totalAmount': 1149.67,
                    },
                    'response': ETA_TEST_RESPONSE,
                    ...
                    'request': {**COMMON_REQUEST_DICT,
                        ...
                        'invoiceLines': [
                            ...
                            },
                            {
                                ...
                                'itemsDiscount': 0.0,
                                'unitValue': {'currencySold': 'EGP', 'amountEGP': 999.55},
                                'discount': {'rate': 13.0, 'amount': 649.71},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 4997.75,
                                'netTotal': 4348.04,
                                'total': 4348.04,
                        ...
                        'totalDiscountAmount': 661.81,
                        'totalSalesAmount': 5118.74,
                        'netAmount': 4456.93,
                        'totalAmount': 4456.93,
                    },
                    'response': ETA_TEST_RESPONSE,
                        ...
                        'invoiceLines': [
                            {
                                ...
                                'discount': {'rate': 10.0, 'amount': 61.07944},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 610.69944,
                                'netTotal': 549.62,
                                'total': 549.62,
                            },
                            {
                                ...
                                'unitValue': {
                                    'currencySold': 'AED',
                                    'amountEGP': 5045.24862,
                                    'currencyExchangeRate': 5.04752,
                                    'amountSold': 999.55,
                                },
                                'discount': {'rate': 13.0, 'amount': 3279.42308},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 25226.24308,
                                'netTotal': 21946.82,
                                'total': 21946.82,
                            },
                        ],
                        'taxTotals': [{'taxType': 'T1', 'amount': 0.0}],
                        'totalDiscountAmount': 3340.50252,
                        'totalSalesAmount': 25836.94252,
                        'netAmount': 22496.44,
                        ...
                        'invoiceLines': [
                            {
                                ...
                                'discount': {'rate': 10.0, 'amount': 50.472},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 504.752,
                                'netTotal': 454.28,
                                'total': 454.28,
                            },
                            {
                                ...
                                'discount': {'rate': 13.0, 'amount': 329.25316},
                                'taxableItems': [{'taxType': 'T1', 'amount': 0.0, 'subType': 'V003', 'rate': 0.0}],
                                'salesTotal': 2532.59316,
                                'netTotal': 2203.34,
                                'total': 2203.34,
                            },
                        ],
                        'taxTotals': [{'taxType': 'T1', 'amount': 0.0}],
                        'totalDiscountAmount': 379.72516,
                        'totalSalesAmount': 3037.34516,
                        'netAmount': 2657.62,
                        'totalAmount': 2657.62,
                    },
                    'response': ETA_TEST_RESPONSE,
    ...
    def test_8_test_serialization_function(self):
        with freeze_time(self.frozen_today), patch(
            ...
            self.assertEqual(serialized_string, '"ISSUER""ADDRESS""COUNTRY""EG""GOVERNATE""Cairo""REGIONCITY""Iswan""STREET""12th dec. street""BUILDINGNUMBER""10""POSTALCODE""""BRANCHID""0""NAME""branch partner""TYPE""B""ID""918KKL1""RECEIVER""ADDRESS""COUNTRY""EG""GOVERNATE""Cairo""REGIONCITY""Iswan""STREET""12th dec. street""BUILDINGNUMBER""12""POSTALCODE""""NAME""عميل 1""TYPE""B""ID""EG11231212""DOCUMENTTYPE""i""DOCUMENTTYPEVERSION""1.0""DATETIMEISSUED""2022-03-15T00:00:00Z""TAXPAYERACTIVITYCODE""8121""INTERNALID""INV/2022/00001""INVOICELINES""INVOICELINES""DESCRIPTION""product_a""ITEMTYPE""GS1""ITEMCODE""1KGS1TEST""UNITTYPE""C62""QUANTITY""1.0""INTERNALCODE""""VALUEDIFFERENCE""0.0""TOTALTAXABLEFEES""0.0""ITEMSDISCOUNT""0.0""UNITVALUE""CURRENCYSOLD""AED""AMOUNTEGP""504.752""CURRENCYEXCHANGERATE""5.04752""AMOUNTSOLD""100.0""DISCOUNT""RATE""10.0""AMOUNT""50.472""TAXABLEITEMS""TAXABLEITEMS""TAXTYPE""T1""AMOUNT""0.0""SUBTYPE""V003""RATE""0.0""SALESTOTAL""504.752""NETTOTAL""454.28""TOTAL""454.28""INVOICELINES""DESCRIPTION""product_b""ITEMTYPE""EGS""ITEMCODE""EG-EGS-TEST""UNITTYPE""CMT""QUANTITY""5.0""INTERNALCODE""""VALUEDIFFERENCE""0.0""TOTALTAXABLEFEES""0.0""ITEMSDISCOUNT""0.0""UNITVALUE""CURRENCYSOLD""AED""AMOUNTEGP""506.51863""CURRENCYEXCHANGERATE""5.04752""AMOUNTSOLD""100.35""DISCOUNT""RATE""13.0""AMOUNT""329.25316""TAXABLEITEMS""TAXABLEITEMS""TAXTYPE""T1""AMOUNT""0.0""SUBTYPE""V003""RATE""0.0""SALESTOTAL""2532.59316""NETTOTAL""2203.34""TOTAL""2203.34""TAXTOTALS""TAXTOTALS""TAXTYPE""T1""AMOUNT""0.0""TOTALDISCOUNTAMOUNT""379.72516""TOTALSALESAMOUNT""3037.34516""NETAMOUNT""2657.62""TOTALAMOUNT""2657.62""EXTRADISCOUNTAMOUNT""0.0""TOTALITEMSDISCOUNTAMOUNT""0.0""SIGNATURES""SIGNATURES""1""1"')
