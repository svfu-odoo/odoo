...
class Company(models.Model):
    ...
    parent_ids = fields.Many2many('res.company', compute='_compute_parent_ids', compute_sudo=True, search='_search_parent_ids')
    ...
    def _search_parent_ids(self, operator, value):
        assert operator in ('=', 'in')
        return [('id', 'parent_of', value)]
